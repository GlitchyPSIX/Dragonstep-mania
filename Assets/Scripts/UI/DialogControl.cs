...
public class DialogControl : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        buttonLSFX = transform.Find("DialogBG").transform.Find("ButtonL").transform.Find("SFX").GetComponent<AudioSource>();
        buttonMSFX = transform.Find("DialogBG").transform.Find("ButtonM").transform.Find("SFX").GetComponent<AudioSource>();
        buttonRSFX = transform.Find("DialogBG").transform.Find("ButtonR").transform.Find("SFX").GetComponent<AudioSource>();
    }
                          ...
                          string buttonLS = "", string buttonRS = "", string buttonMS = "")
    {
        ...
        if (buttonMASFX == null || buttonLASFX == null || buttonRASFX == null)
        {
            Debug.Log("Sounds were incorrectly assigned.");
        }
        else
        {
